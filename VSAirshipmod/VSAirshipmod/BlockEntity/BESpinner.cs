...
using VSAirshipmod.Gui;
using VSAirshipmod.Inventory;
...
namespace VSAirshipmod.NSBlockEntity
{
    public class BlockEntitySpinner : BlockEntityOpenableContainer
    {
        ...
        internal InventorySpinner inventory;
        ...
        GuiDialogBlockEntitySpinner clientDialog;
        ...
        public float GrindSpeed
        {
            get
            {
                ...
                if (automated && mpc.Network != null) return mpc.TrueSpeed/2;
        ...
        {
            inventory = new InventorySpinner(null, null);
        ...
        public override bool OnPlayerRightClick(IPlayer byPlayer, BlockSelection blockSel)
        {
            ...
            if (Api.Side == EnumAppSide.Client)
            {
                toggleInventoryDialogClient(byPlayer, () => {
                    clientDialog = new GuiDialogBlockEntitySpinner(DialogTitle, Inventory, Pos, Api as ICoreClientAPI);
                    clientDialog.Update(inputGrindTime, maxGrindingTime());
                    return clientDialog;
                });
            }
        ...
        public ItemStack InputGrindProps
        {
            get
            {
                ...
                if (slot.Itemstack == null || slot.Itemstack.Collectible.Code != "flaxfibers" || slot.Itemstack.StackSize < inputnum) return null;
