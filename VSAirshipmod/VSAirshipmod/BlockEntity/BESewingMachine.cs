...
using VSAirshipmod.BlockEntityRenderer;

namespace VSAirshipmod.NSBlockEntity
{
    public class BlockEntitySewingMachine : BlockEntityOpenableContainer
    {
        static SimpleParticleProperties FlourParticles;
        static SimpleParticleProperties FlourDustParticles;

        static BlockEntitySewingMachine()
        {
            // 1..20 per tick
        ...
        public float GrindSpeed
        {
            get
            {
                ...
                if (automated && mpc.Network != null) return mpc.TrueSpeed/4;
        ...
        {
            get { return "sewingmachine"; }
        }

        public virtual string DialogTitle
        {
            get { return Lang.Get("Sewing Machine"); }
        }
        ...
        public BlockEntitySewingMachine()
        {
        ...
        public override void Initialize(ICoreAPI api)
        {
            ...
            inventory.LateInitialize("sewingmachine-" + Pos.X + "/" + Pos.Y + "/" + Pos.Z, api);
            ...
            {
                renderer = new CQuernTopRenderer(api as ICoreClientAPI, Pos, GenMesh("top"));
        ...
        {
            ItemStack grindProps = InputGrindProps;
        ...
        public ItemStack InputGrindProps
        {
            get
            {
                ...
                if (slot.Itemstack == null || slot.Itemstack.Collectible.Code != "linen-normal-down" || slot.Itemstack.StackSize < inputnum) return null;
                //return slot.Itemstack.Collectible.GrindingProps;
                return new ItemStack(Api.World.GetItem(new AssetLocation("game:cloth-plain")),outputnum);
            }
        }
