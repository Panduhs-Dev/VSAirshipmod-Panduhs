    ...
    public class BlockEntityAutoloom : BlockEntityOpenableContainer
    {
        ...
        public ItemStack InputGrindProps
        {
            get
            {
                ...
                if (slot.Itemstack == null || slot.Itemstack.Collectible.Code != "flaxtwine" || slot.Itemstack.StackSize < inputnum) return null;
