...
{
    public class BlockSewingMachine : BlockMPBase
    {
        ...
        public override bool OnBlockInteractStart(IWorldAccessor world, IPlayer byPlayer, BlockSelection blockSel)
        {
            ...
            BlockEntitySewingMachine beQuern = world.BlockAccessor.GetBlockEntity(blockSel.Position) as BlockEntitySewingMachine;
                ...
                return new WorldInteraction[] {
                    new WorldInteraction()
                    {
                        ...
                        ShouldApply = (wi, bs, es) => {
                            BlockEntitySewingMachine beQuern = world.BlockAccessor.GetBlockEntity(bs.Position) as BlockEntitySewingMachine;
