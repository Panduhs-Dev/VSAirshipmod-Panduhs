...
namespace VSAirshipmod.NSBlock
{
    public class BlockSpinner : BlockMPBase
    {
        ...
        public override bool OnBlockInteractStart(IWorldAccessor world, IPlayer byPlayer, BlockSelection blockSel)
        {
            ...
            BlockEntitySpinner beQuern = world.BlockAccessor.GetBlockEntity(blockSel.Position) as BlockEntitySpinner;
                ...
                return new WorldInteraction[] {
                    new WorldInteraction()
                    {
                        ...
                        ShouldApply = (wi, bs, es) => {
                            BlockEntitySpinner beQuern = world.BlockAccessor.GetBlockEntity(bs.Position) as BlockEntitySpinner;
