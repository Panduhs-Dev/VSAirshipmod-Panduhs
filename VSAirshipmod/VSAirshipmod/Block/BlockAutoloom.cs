...
namespace VSAirshipmod.NSBlock
{
    public class BlockAutoloom : BlockMPBase
    {
        ...
        public override bool OnBlockInteractStart(IWorldAccessor world, IPlayer byPlayer, BlockSelection blockSel)
        {
            ...
            BlockEntityAutoloom beQuern = world.BlockAccessor.GetBlockEntity(blockSel.Position) as BlockEntityAutoloom;
                ...
                return new WorldInteraction[] {
                    new WorldInteraction()
                    {
                        ...
                        ShouldApply = (wi, bs, es) => {
                            BlockEntityAutoloom beQuern = world.BlockAccessor.GetBlockEntity(bs.Position) as BlockEntityAutoloom;
