...
namespace VSAirshipmod.Gui
{
    public class GuiDialogBlockEntitySpinner : GuiDialogBlockEntity
    {
        long lastRedrawMs;

        protected override double FloatyDialogPosition => 0.75;

        public GuiDialogBlockEntitySpinner(string DialogTitle, InventoryBase Inventory, BlockPos BlockEntityPosition, ICoreClientAPI capi)
