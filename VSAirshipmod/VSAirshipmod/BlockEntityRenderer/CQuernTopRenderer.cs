...
namespace VSAirshipmod.BlockEntityRenderer
{
    public class CQuernTopRenderer : IRenderer
    {
        ...
        public CQuernTopRenderer(ICoreClientAPI coreClientAPI, BlockPos pos, MeshData mesh)
        {
